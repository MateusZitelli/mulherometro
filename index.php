...
<html>
	...
	<div class="row-fluid" style="text-align:center; " id="search_input">
		<div class="span12" >
			<input id='input_link' type='text' name='event' style='width:260px; height:40px; text-align:center; display:none;' onfocusout='search_show();' onfocus='search_show();' onkeyup='search_drop();' placeholder='Pesquise aqui'>
		</div>
	</div>
