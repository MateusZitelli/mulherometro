...
function event_show(search_id){
	...
	FB.api('/fql?access_token='+window.fbtoken, {q: query}, function(obj) {
		...
		document.getElementById("header").innerHTML='<div class="span12"><a style="text-decoration:none;" target="_blank" href="https://www.facebook.com/events/'+search_id+'"><h3>'+event_name+'</h3></a></div>';
	});
